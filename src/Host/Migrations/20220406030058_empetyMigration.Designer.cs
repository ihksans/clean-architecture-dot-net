...
namespace Garuda.Host.Migrations
{
    ...
    [Migration("20220406030058_empetyMigration")]
    partial class empetyMigration
    {
            ...
            modelBuilder.Entity("Garuda.Modules.Common.Models.Datas.Group", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("81314787-537b-474f-999a-9152c9703bbb"),
                            CreatedDate = new DateTime(2022, 4, 6, 10, 0, 53, 437, DateTimeKind.Local).AddTicks(1792),
                            DeletedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Administrator",
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("81314787-537b-474f-999a-9152c9703bbb"),
                            CreatedDate = new DateTime(2022, 4, 6, 10, 0, 53, 437, DateTimeKind.Local).AddTicks(1835),
                            DeletedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("81314787-537b-474f-999a-9152c9703bbb"),
                            CreatedDate = new DateTime(2022, 4, 6, 10, 0, 53, 437, DateTimeKind.Local).AddTicks(1843),
                            DeletedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Mine Head",
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
            ...
            modelBuilder.Entity("Garuda.Modules.Common.Models.Datas.UserGroup", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("81314787-537b-474f-999a-9152c9703bbb"),
                            CreatedDate = new DateTime(2022, 4, 6, 10, 0, 53, 472, DateTimeKind.Local).AddTicks(3037),
                            DeletedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            GroupId = new Guid("1ce881eb-4ae2-4b04-83d9-7062e6cfffd5"),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            UserId = new Guid("b5a93e5d-e159-4c69-b90d-ae3239a692d3")
